//
//  TPAlertPresentationController.m
//  WK
//
...
@interface TPActivityPresentationController () <UIViewControllerAnimatedTransitioning>
@property (nonatomic, strong) UIView *dimmingView;
@property (nonatomic, strong) UIView *presentationWrappingView;
@end
@implementation TPActivityPresentationController
...
- (void)presentationTransitionWillBegin {
    ...
    // SEE ALSO: The note in AAPLCustomPresentationSecondViewController.m.
    {
        ...
        presentationWrapperView.layer.shadowOpacity = 0.1f;
